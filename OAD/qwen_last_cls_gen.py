...
class LiveInfer_nocache:
    def __init__(self, model, tokenizer, args, classnames) -> None:
        ...
        #a = self.tokenizer.apply_chat_template([sys_prompt,{"role": "stream", 'num_frames': 0, 'learn': False}], return_tensors='pt', tokenize=False)
        ...
        self._added_generation_ids = torch.cat([self._sys_ids_tot[:, -3:], self._added_generation_ids_ass], dim=-1)
